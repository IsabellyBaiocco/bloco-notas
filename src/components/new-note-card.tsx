...
export function NewNoteCard ({onNoteCreated}: NewNoteCardProps) {
 ...
 return (
    <Dialog.Root>
        <Dialog.Trigger className='rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 focus-visible:ring-2'>
                    ...
                    <form className='flex-1 flex flex-col'>
                        ...
                        {isRecording ? (
                            ...
                            <button
                                ...
                                className='w-full bg-blue-600 py-4 text-center text-sm text-slate-300 outline-none font-medium hover:bg-blue-700'
                            >
                                Salvar nota
                            </button>
                        )}
